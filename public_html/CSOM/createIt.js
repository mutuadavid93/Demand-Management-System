...
<!-- FileName: createlt.js on CREATORS.aspx -->
<div class='container'>
    <div class='row'>
        <div class='col-xl-12'>
            <p id="message"></p>
    ...
    $(document).ready(function() {
        ...
        var createListItem = function() {
            ...
            call.fail(function(jqXHR, textStatus, errorThrown) {
             ...
             function addItem(userId){ 
                ...
                // Make sure they Fill All Fields
                if(ProjTitle != '' && sponsor != '' && ProjOwner != '' 
                        && $("#projPillars").val() != '' && $("#Prioritization").val() != ''  
                        && $("#BUnits").val() != '' && $('#inputStartDate').val()){
                    ...
                    var call = jQuery.ajax({
                        ...
                        data: JSON.stringify({
                            ...
                            EmpID: _spPageContextInfo.userId,
                    ...
                    alert("Kindly fill in all the fields on the New Project Request Details Section");
                }
        ...
        function uploadDocument(ItemRef_ID) {  
            ...
            function success2() {
                ...
                window.location.href = "https://safaricomo365.sharepoint.com/sites/pwa/default.aspx";
            }

            function fail(sender, args) {
               alert("This Happens When You Don't Attach a File: "+args.get_message());
            }
        } // uploadDocument
    }); //SP.SOD.executeFunc()
